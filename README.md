# SyntheAI： PyTorch, TensorFlow and JAX Unified Development Environment version:3.2
...
* 自動化に伴い内部のコードを調整しました。
## 【重要】SyntheAI 自動ライブラリ更新システムの運用終了と今後について
SyntheAIプロジェクトをご利用いただきありがとうございます。

2026年3月より運用してまいりました「GPU依存ライブラリ自動更新システム」ですが、諸般の事情により、本システムによる自動運用の継続を終了させていただくこととなりました。

今後の運用につきましては、以下の通りとなります。
1. 自動更新に使用していたスクリプト自体は引き続きリポジトリ内に保持いたします。依存関係の解決が必要な場合は、各自の環境にて本スクリプトをご活用ください。

2. 個別でのライブラリ更新や機能改善に関するPRにつきましては、今後も継続して受け付けております。
急なご案内となり恐縮ですが、コミュニティの皆様によるメンテナンスや貢献を心よりお待ちしております。今後ともSyntheAIをよろしくお願いいたします。
